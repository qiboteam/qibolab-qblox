...
project = "qibolab-qblox"
copyright = "2025, The Qibo team"
author = "The Qibo team"

release = qibolab_qblox.__version__
...
autodoc_mock_imports = ["qblox-instruments"]
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/qiboteam/qibolab-qblox/",
    "source_branch": "main",
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/qiboteam/qibolab-qblox",
            "html": """
...
def run_apidoc(_):
    ...
    package = source.parents[1] / "src" / "qibolab_qblox"
